...
import net.sf.yad2xx.util.NativeLibraryLoader;
...
public class FTDIInterface {
    ...
    /**
     * Loads the native library on first class usage.
     */
    static {
     ...
     * @since 0.2
     */
    native static void setChars(long ftHandle, char event, boolean eventEnable, char error, boolean errorEnable)
     ...
     * @since 0.3
     */
    native static void setDataCharacteristics(long ftHandle, byte wordLength, byte stopBits, byte parity)
            throws FTDIException;
